...
RSpec.describe "Api::Expenses", type: :request do
  ...
  describe "POST /api/expenses" do
    ...
    context "with invalid parameters" do
      it "returns unprocessable entity for negative amounts" do
        invalid_params = {
          expense: {
      ...
      it "returns unprocessable entity for empty descriptions" do
        invalid_params = {
          expense: {
            description: "",
            amount: 100.00,
      ...
      it "returns unprocessable entity for future dates" do
        invalid_params = {
          expense: {
